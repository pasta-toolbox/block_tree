...
class BlockTreeLPFParallelTest : public ::testing::Test {

protected:

  std::vector<uint8_t> text;

  BlockTreeLPF<uint8_t, int32_t>* bt;
  ...
  void SetUp() override {
    ...
    bt = make_block_tree_lpf_parallel<uint8_t, int32_t>(text, 2, 1, true, 4);
...
TEST_F(BlockTreeLPFParallelTest, select) {
  std::array<size_t, 256> hist = {0};
