...
//    BV_BlockTree_fp_theory<uint8_t, int32_t> *lpf_bt = new BV_BlockTree_fp_theory<uint8_t, int32_t>(vec,2,1,1);

    BV_BlockTree_fp_pruned<uint8_t, int32_t> *fp_bt = new BV_BlockTree_fp_pruned<uint8_t, int32_t>(vec, 2, 1, 1);
